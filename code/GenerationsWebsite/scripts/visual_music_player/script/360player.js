...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#102035', // how much has loaded
    playRingColor: '#76c6fe', // how much has played
    backgroundRingColor: '#0C101D', // color shown underneath load + play ("not yet loaded" color)
    ...
    circleRadius: null,
    imageRoot: './scripts/visual_music_player/', // image path to prepend for transparent .GIF - eg. /images/
    animDuration: 500,
...
this.updatePlaying = function() {
  ...
  this.getUIHTML = function() {
    return [
     ...
     ' <img width="100px" height="100px" src="'+self.config.imageRoot+'empty.gif" class="sm2-360btn sm2-360btn-default" style="border:none" />', // note use of imageMap, edit or remove if you use a different-size image.
