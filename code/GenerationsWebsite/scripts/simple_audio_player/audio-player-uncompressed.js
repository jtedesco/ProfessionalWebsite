	...
	return {
		setup: function (url, options) {
			...
			if (swfobject.hasFlashPlayerVersion(requiredFlashVersion)) {
				...
				swfobject.createCSS("p.audioplayer_container span", "visibility:hidden;height:24px;overflow:hidden;padding:0;border:none;font-family: 'Comic Sans MS', cursive;");
			}
		},
