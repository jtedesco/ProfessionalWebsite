...
var AudioPlayer = function() {
    ...
    return{setup:function(J, I) {
        ...
        if (audioplayer_swfobject.hasFlashPlayerVersion(G)) {
            ...
            audioplayer_swfobject.createCSS("p.audioplayer_container span", "visibility:hidden;height:24px;overflow:hidden;padding:0;border:none;font-family: 'Comic Sans MS', cursive;")
        }
