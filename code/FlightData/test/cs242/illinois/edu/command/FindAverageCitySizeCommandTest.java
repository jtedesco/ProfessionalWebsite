 ...
 * <p> Date: Sep 30, 2010
 *
 * <p> <p> Tests that we can find the average flight length correctly
 */
public class FindAverageCitySizeCommandTest extends TestCase {
    ...
    /**
     * Tests that the average city size we find is correct, based on the sample input data
     */
    public void testFindAverageCitySizeCommand() {

        //Setup
        FindAverageCitySizeCommand command = new FindAverageCitySizeCommand();
        double expectedValue = (8600000 + 6000000 + 9050000 + 23400000 + 15200000 + 10400000 + 7050000 + 4475000)/ (8.0);

        //Test
        List<FlightGraphVertex> cities = FlightGraphUtilities.getFlightGraphVertices(graph);
        double actualValue = command.findAverageCitySize(cities);
