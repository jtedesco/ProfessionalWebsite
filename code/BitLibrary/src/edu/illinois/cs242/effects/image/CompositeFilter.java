...
public class CompositeFilter extends AbstractBufferedImageOp {
	...
	/**
     * Construct a CompositeFilter.
     * @param composite the edu.illinois.cs242.effects.composite to use
     */
	...
	/**
     * Set the edu.illinois.cs242.effects.composite.
     * @param composite the edu.illinois.cs242.effects.composite to use
     * @see #getComposite
     */
	...
	/**
     * Get the edu.illinois.cs242.effects.composite.
     * @return the edu.illinois.cs242.effects.composite to use
     * @see #setComposite
     */
