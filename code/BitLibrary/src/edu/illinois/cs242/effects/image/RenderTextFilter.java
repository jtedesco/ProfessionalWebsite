...
package edu.illinois.cs242.effects.image;
...
public class RenderTextFilter extends AbstractBufferedImageOp {
     ...
     * @param composite the edu.illinois.cs242.effects.composite (may be null)
	...
	/**
     * Set the edu.illinois.cs242.effects.composite with which to paint the text.
     * @param composite the edu.illinois.cs242.effects.composite
     * @see #getComposite
     */
	...
	/**
     * Get the edu.illinois.cs242.effects.composite with which to paint the text.
     * @return the edu.illinois.cs242.effects.composite
     * @see #setComposite
     */
