package edu.illinois.cs242.model.outputstream;
    ...
    implements BZip2Constants
{
    ...
    public BZipOutputStream( final OutputStream output )
        throws IOException
    {
        this( output, 9 );
    }

    public BZipOutputStream( final OutputStream output, final int blockSize )
        throws IOException
    {
        bsSetStream( output );
        m_workFactor = 50;
    ...
    private void qSort3( int loSt, int hiSt, int dSt )
    {
        ...
        int hi;
        int d;
        BZipOutputStream.StackElem[] stack = new BZipOutputStream.StackElem[ QSORT_STACK_SIZE ];
        for( int count = 0; count < QSORT_STACK_SIZE; count++ )
        {
            stack[ count ] = new BZipOutputStream.StackElem();
        }
