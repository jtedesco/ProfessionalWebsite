 ...
 */
public class EffectsMenuActionFactory implements MenuActionFactory{
    ...
    public ActionListener buildMenuAction(String buttonConstant){
        try{
            return EffectsMenuActions.valueOf(buttonConstant).getActionListener();
        } catch (Exception e){
            throw new UnsupportedOperationException("Error getting effects menu actions:\n" + e.getMessage());
        }
    }
}
